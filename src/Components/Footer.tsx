...
const Footer = () => {
  return (
    <div className="bg-[#028643] py-[100px] px-[150px]">
      <div className="border-[1px] border-white border-l-0 border-r-0 px-[50px] py-[70px] flex flex-row items-center justify-between">
        <div>
